...
<main>
        ...
        ?>
        <h2><?php echo $webPhishingH1; ?></h2>
        <p><?php echo $webPhishingP1; ?></p>
        <p><?php echo $webPhishingP2; ?></p>
        <ul>
            <?php
        ...
        <p><?php echo $webPhishingP3; ?></p>
        <?php echo $webPhishingImg; ?>
        <p><?php echo $webPhishingP4; ?></p>
        <ul>
            <?php
            // Explode the heredoc string by newline
            $listItems = explode("\n", $webPhishingList2);
        ...
        <p><?php echo $webPhishingP5; ?></p>
        <h2><?php echo $webPhishingH2; ?></h2>
        <p><?php echo $webPhishingP6; ?></p>
        <ul>
            <?php
            // Explode the heredoc string by newline
            $listItems = explode("\n", $webPhishingList3);
